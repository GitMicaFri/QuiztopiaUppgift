import jwt from 'jsonwebtoken'; // Bibliotek för att hantera JWT-verifiering
import { promisify } from 'util'; // Konverterar callback-baserade funktioner till promises
        ...
        try {
            ...
            if (!authHeader || !authHeader.startsWith('Bearer ')) {
                return sendError(401, {
                    message: 'No or invalid token provided.', // Felmeddelande om token saknas/är felaktigt
                });
            }
            ...
            if (error.name === 'TypeError') {
                return sendError(401, {
                    success: false,
                    message: 'No token provided.', // Om inget token skickades
                });
